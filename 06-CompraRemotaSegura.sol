...
contract Purchase {
    ...
    /// Sólo puede ser llamado por el vendedor antes de que el contrato se cierre.
    ...
    /// La transacción debe incluir la cantidad de ether multiplicada por 2. 
    /// El ether quedará bloqueado hasta que se llame a confirmReceived.
    ...
    /// Confirma que ha recibido el artículo (comprador). Esto desbloqueará el ether.
